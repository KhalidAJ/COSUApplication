...
class MenuPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      home: new CoffeeShopListPage(),
    );
  }
}

class CoffeeShopListPage extends StatefulWidget {
  CoffeeShopListPage({Key? key}) : super(key: key);

  @override
  _CoffeeShopListPageState createState() => _CoffeeShopListPageState();
}

class _CoffeeShopListPageState extends State<CoffeeShopListPage> {
  late List shops;
